...
<html lang="en">
    <head>
        ...
        <title>EDU TRACKER| Add Courses </title>
...
<?php }} ?>
                                                ...
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label" >Courses Done</label>
                                                        <div class="col-sm-10">
 <input type="number" name="subjectname" onblur="addInputs(this)" class="form-control" id="default" placeholder="Number of Courses Done" required="required" style="width: 709px; margin-left: 9px;">
 ...
 <!-- <input type="file" name="subjectcode" class="form-control" id="default" placeholder="" multiple="multiple"   required="required" style="width: 709px; " > -->
        ...
        <script>
            ...
            function addInputs(elm) {
                ...
                wrapper.innerHTML = '<label for=default style=" margin-top: 10px;" >Course No. '+i+'</label><input type="text" name="subjectcode" class="form-control" id="default" placeholder="Name of the Course" required="required" style="width: 709px; margin-left: 8px; margin-top: 5px;">' + '<label for=default style=" margin-top: 10px;" >Upload Certificate ' + i + '</label><input type="file" name="subjectcode" class="form-control" id="default" placeholder="" multiple="multiple" required="required" style="width: 709px; margin-left: 8px; margin-top: 5px;">';
