...
<html lang="en">
    <head>
        ...
        <title>EDU TRACKER| Add Projects </title>
...
<?php }} ?>
                                                ...
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label" >Projects Done</label>
                                                        <div class="col-sm-10">
 <input type="number" name="subjectname" onblur="addInputs(this)" class="form-control" id="default" placeholder="Number of Projects Done" required="required" style="width: 709px; margin-left: 9px;">
 ...
 <!-- <input type="file" name="subjectcode" class="form-control" id="default" placeholder="" multiple="multiple"   required="required" style="width: 709px; " > -->
        ...
        <script>
            ...
            function addInputs(elm) {
                ...
                wrapper.innerHTML = '<label for=default style=" margin-top: 10px;" >Project No. '+i+'</label><input type="text" name="subjectcode" class="form-control" id="default" placeholder="Name of the Project" required="required" style="width: 709px; margin-left: 8px; margin-top: 5px;">' + '<label for=default style=" margin-top: 10px;" >Project Link ' + i + '</label><input type="url" name="subjectcode" class="form-control" id="default" placeholder="Github Link of the Project" multiple="multiple" required="required" style="width: 709px; margin-left: 8px; margin-top: 5px;">';
