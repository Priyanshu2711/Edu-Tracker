...
<html lang="en">
    <head>
        ...
        <title>EDU TRACKER | Dashboard</title>
                    ...
                    <div class="main-page">
                        ...
                        <section class="section">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="dash-img">
                                   <center><img src="https://www.clipartkey.com/mpngs/m/139-1397326_administration-illustration.png" style="height:60%; width:80%; padding-top: 30px; "alt="yoast seo"/></center> 
                                    </div>
...
?>
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Welcome to Edu Tracker!");
